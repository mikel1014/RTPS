...
class EEJoyStick: SKNode {
    ...
    private static var DEFAULT_POINT = CGPoint(x: 0, y: 0)
    ...
    override init(){
        ...
        base = SKSpriteNode(imageNamed: "Analog_JoyStick_Base.png")
        joyStick = SKSpriteNode(imageNamed: "Analog_Joystick_Handle.png")
        super.init()
